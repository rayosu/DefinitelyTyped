...
export class Commands {
    ...
    public static FF = '\x0c';
    public static GS = '\x1d';
    public static DLE = '\x10';
    public static EOT = '\x04';
    public static NUL = '\x00';
    public static ESC = '\x1b';
    public static EOL = '\n';
     ...
     * @type {Object}
     */
    public static FEED_CONTROL_SEQUENCES = {
    ...
    public static CHARACTER_SPACING = {
        CS_DEFAULT: '\x1b\x20\x00',
        CS_SET: '\x1b\x20',
    }

    public static LINE_SPACING = {
        LS_DEFAULT: '\x1b\x32',
        LS_SET: '\x1b\x33'
    }
     ...
     * @type {Object}
     */
    public static CODE2D_FORMAT = {
        TYPE_PDF417: Commands.GS + 'Z' + '\x00',
        TYPE_DATAMATRIX: Commands.GS + 'Z' + '\x01',
        TYPE_QR: Commands.GS + 'Z' + '\x02',
        CODE2D: Commands.ESC + 'Z',
     ...
     * @type {string}
     */
    public static BEEP = '\x1b\x42'; // Printer Buzzer pre hex
